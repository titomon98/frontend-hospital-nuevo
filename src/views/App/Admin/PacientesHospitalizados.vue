        ...
        <b-tabs content-class="mt-3">
          <b-tab title="Medicamento" active>
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_medicamentos/listSinEmergencia/' + cuenta.id"
          ...
          <b-tab title="Anestésicos">
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_medicamentos/listSinEmergenciaAnestesicos/' + cuenta.id"
              :query-params="makeQueryParamsConsumoInsumo"
              data-path="data"
              pagination-path=""
              :per-page="perPage"
          ...
          <b-tab title="Quirúrgico">
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_quirugicos/listSinEmergencia/' + cuenta.id"
              :query-params="makeQueryParamsConsumoInsumo"
              :per-page="perPage"
              :reactive-api-url="true"
          ...
          <b-tab title="Común">
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_comun/listSinEmergencia/' + cuenta.id"
              :query-params="makeQueryParamsConsumoInsumo"
              :per-page="perPage"
              :reactive-api-url="true"
      ...
      <b-col md="12">
        <iq-card>
          <template v-slot:headerTitle>
            <h4 class="card-title mt-3">Todos los Pacientes Hospitalizados</h4>
...
export default {
  ...
  data () {
    return {
      ...
      item_examenes: [],
      apiBase: apiUrl + '/expedientes/listPacientesActivos',
      apiBaseReceta: '',
      apiBaseConsumo: '',
