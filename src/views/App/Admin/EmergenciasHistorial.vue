        ...
        <b-tabs content-class="mt-3">
          <b-tab title="Medicamento" active>
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_medicamentos/list/' + cuenta.id + '/Emergencia'"
          ...
          <b-tab title="Anestésicos">
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_medicamentos/listAnestesicos/' + cuenta.id + '/Emergencia'"
              :query-params="makeQueryParamsConsumoInsumo"
              data-path="data"
              pagination-path=""
              :per-page="perPage"
          ...
          <b-tab title="Quirúrgico">
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_quirugicos/list/' + cuenta.id + '/Emergencia'"
              :query-params="makeQueryParamsConsumoInsumo"
              :per-page="perPage"
              :reactive-api-url="true"
          ...
          <b-tab title="Común">
            <vuetable
              ...
              class="table-divided table-responsive order-with-arrow"
              :api-url="apiUrl + '/detalle_consumo_comun/list/' + cuenta.id + '/Emergencia'"
              :query-params="makeQueryParamsConsumoInsumo"
              :per-page="perPage"
              :reactive-api-url="true"
      ...
      <b-col md="12">
        <iq-card>
          <template v-slot:headerTitle>
            <h4 class="card-title mt-3">Historial de Emergencias</h4>
...
export default {
  ...
  data () {
    return {
      ...
      item_examenes: [],
      apiBase: apiUrl + '/expedientes/listEmergenciaHistorial',
      apiBaseReceta: '',
      apiBaseConsumo: '',
