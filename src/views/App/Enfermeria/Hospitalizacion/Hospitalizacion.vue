      ...
      <template #modal-footer>
        ...
        <div class="mt-2 mb-3">
          ...
          <div v-if="puedeRevisarConsumos" class="mt-2">
            <revisar-consumos :id-cuenta="revisionConsumos.idCuenta" movimiento="SALIDAH" :rubro="rubroConsumoActivo" @finalizado="onRevisionFinalizada" />
          </div>
        </div>
            ...
            >
              ...
              <template slot="actions" slot-scope="props">
                <div class="button-container">
                  ...
                  <b-button
                      v-b-tooltip.top="['PENDIENTE', ' ', null].includes(props.rowData.cuentas[0].motivo_egreso) ? 'Agregar nota de ingreso' : 'Modificar nota de egreso'"
...
export default {
  ...
  methods: {
    ...
    closeModal (action) {
      switch (action) {
        ...
        case 'SaveQuirurgico': {
          ...
          this.formQui.movimiento = 'SALIDAH'
          this.existencias_selected_med = null
          break
        }
        case 'SaveComunes': {
          ...
          this.formCom.movimiento = 'SALIDAH'
          this.existencias_selected_med = null
          break
        }
        case 'modal_agregar': {
    ...
    async recalcularTotalesConsumos () {
      ...
      const r = await axios.get(apiUrl + `/cuentas/getTotales/Hospitalizacion?id=${this.idCuentaSeleccionada}`)
    ...
    async getConsumoMedicamentos (id) {
      try {
        ...
        if (response.data && response.data.id) {
          ...
          this.apiBaseConsumoAnestesicos = apiUrl + `/detalle_consumo_medicamentos/listAnestesicos/${response.data.id}/Hospitalizacion`
