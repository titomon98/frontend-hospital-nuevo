      ...
      <b-col md="12">
        <iq-card>
            <template v-slot:headerTitle>
              <h4 class="card-title mt-3">Egresos hospitalización</h4>
            ...
            >
              ...
              <div slot="estado" slot-scope="props">
                <h5 v-if="props.rowData.estado == 1">
                  <b-badge variant="light"
                    ><h6 class="success"><strong>EN HABITACIÓN</strong></h6></b-badge
                  >
                </h5>
                <h5 v-else>
                  <b-badge variant="light"
                    ><h6 class="danger"><strong>EN HABITACIÓN</strong></h6></b-badge
                  >
                </h5>
              </div>
              <!-- Botones -->
              <template slot="actions" slot-scope="props">
                <div class="button-container">
                  ...
                  <b-button
                    @click="setData(props.rowData); $bvModal.show('modal-1-trasladoHosp')"
                    class="mb-2 button-spacing"
                    size="sm"
                    variant="success"
                  >
            ...
            .then((res) => {
              if (this.selectedTrasOption === 1 || this.selectedTrasOption === 4) {
                axios
                  ...
                  .then((res) => {
                    this.selectedHab = null
                    /* eslint-disable */console.log(...oo_oo(`1319611087_508_22_508_51_4`,this.selectedHab))
