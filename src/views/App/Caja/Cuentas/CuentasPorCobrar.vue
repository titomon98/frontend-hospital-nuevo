<template>
  <b-container fluid>
    ...
    <b-modal id="modal-reingreso" ref="modal-reingreso" title="Reingresar paciente" size="xl">
      <b-alert
  ...
  methods: {
    ...
    abrirModalReingreso (rowData) {
      ...
      this.formReingreso = {
        ...
        estudioDeSueno: 0,
        habitacion: null,
        id: rowData.id_expediente,
        cuenta: rowData.id,
        expediente: rowData.expediente ? rowData.expediente.expediente : ''
      }
      this.selectedMedicoReingreso = null
      this.doctorsReingreso = []
      this.getHabitacionesReingreso()
      this.$bvModal.show('modal-reingreso')
    },
