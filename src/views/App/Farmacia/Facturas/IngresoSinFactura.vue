<template>
  <b-container fluid>
    ...
    <b-modal id="modal-password-2" ref="modal-password-2" title="Comprobar contraseña">
      <b-alert
    ...
    <b-modal id="modal-1-sin" ref="modal-1-sin" title="Agregar medicamento">
      <b-alert
        :show="alertCountDownError"
        dismissible
        fade
    ...
    <b-modal id="modal-2-sin" ref="modal-2-sin" title="Agregar material quirúrgico">
      <b-alert
        :show="alertCountDownError"
        dismissible
        fade
    ...
    <b-modal id="modal-3-sin" ref="modal-3-sin" title="Agregar material común">
      <b-alert
        :show="alertCountDownError"
        dismissible
        fade
            ...
            <b-row class="ml-2">
              <b-col md="3">
                <b-form-group label="Referencia:">
                  <b-form-input
                    v-model.trim="factura"
                    placeholder="Ingresar de referencia de ingreso"
                  ></b-form-input>
                </b-form-group>
              </b-col>
              <b-col md="3">
            ...
            <b-row class="ml-2">
              <b-col md="4">
                <b-form-group label="Agregar medicamento:">
                  <b-button variant="info" v-b-modal.modal-1-sin>AGREGAR MEDICAMENTO</b-button>
                </b-form-group>
              </b-col>
              <b-col md="4">
                <b-form-group label="Agregar material quirúrgico:">
                  <b-button variant="info" v-b-modal.modal-2-sin>AGREGAR MATERIAL QUIRÚRGICO</b-button>
                </b-form-group>
              </b-col>
              <b-col md="4">
                <b-form-group label="Agregar material común:">
                  <b-button variant="info" v-b-modal.modal-3-sin>AGREGAR MATERIAL COMÚN</b-button>
                </b-form-group>
              </b-col>
            </b-row>
  ...
  methods: {
    ...
    closeModal (action) {
      switch (action) {
        case 'medicamento': {
          this.$v.$reset()
          this.$refs['modal-1-sin'].hide()
          this.resetData()
          break
        }
        case 'quirurgico': {
          this.$v.$reset()
          this.$refs['modal-2-sin'].hide()
          this.resetData()
          break
        }
        case 'comun': {
          this.$v.$reset()
          this.$refs['modal-3-sin'].hide()
          this.resetData()
          break
        }
        case 'save': {
        ...
        case 'login': {
          this.$v.$reset()
          this.$refs['modal-password-2'].hide()
          this.resetData()
          break
        }
      }
    ...
    searching (search, loading) {
      axios.get(apiUrl + '/medicamentos/getSearchNo',
        {
          params: {
            search: search
          }
    ...
    searchingQuirurgico (search, loading) {
      axios.get(apiUrl + '/quirurgico/getSearchNo',
        {
          params: {
            search: search
          }
    ...
    searchingComun (search, loading) {
      axios.get(apiUrl + '/comun/getSearchNo',
        {
          params: {
            search: search
          }
